...
kustomize build common/knative/knative-serving/overlays/gateways | kubectl apply -f - && kustomize build common/knative/knative-serving/overlays/gateways | kubectl apply -f -
